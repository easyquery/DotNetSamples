    ...
    public class DbInitializer {
        ...
        void LoadCustomers() {
            ...
            foreach (XElement element in root.Elements("Result")) {
                Customer customer = new Customer {
                    CustomerID = element.StringValue("CustomerID"),
        ...
        void LoadProducts() {
            ...
            foreach (XElement element in root.Elements("Result")) {
                Product product = new Product {
                    ProductID = element.IntValue("ProductID"),
        ...
        void LoadEmployees() {
            ...
            foreach (XElement element in root.Elements("Result")) {
                ...
                d[employee.EmployeeID] = element.IntValue("ReportsTo");
                _dbContext.Employees.Add(employee);
                _dbContext.SaveChanges();
            }

            foreach (Employee emp in _dbContext.Employees) {
                emp.ReportsTo = d[emp.EmployeeID];
            }
        ...
        void LoadOrders() {
            ...
            foreach (XElement element in root.Elements("Result")) {
                ...
                Order order = new Order {
                    OrderID = element.IntValue("OrderID"),
                    Customer = customer,
                    Product = product,
                    EmployeeId = element.IntValue("EmployeeID"),
        ...
        void LoadOrderDetails() {
            XElement root = LoadFile("OrderDetails.xml");
            foreach (XElement element in root.Elements("Result")) {
